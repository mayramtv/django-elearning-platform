...
class Student(models.Model):
    ...
    start_date = models.DateTimeField(default=datetime.now, blank=False, null=True)
    photo = models.ImageField(upload_to='student_images/', blank=True, null=True)

    def __str__(self): 
        return self.name 

# StudentStatus: each student can show in their home page their own status
